...
| `topbarItems` | object[] | no | Icons shown in the title bar by default. Visible `togglePanel` items can move to the user's optional right-hand rail. See [Topbar](topbar.md). |
